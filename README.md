...
4. [![](https://img.shields.io/badge/LSPosed-ClickMe-blue?link=https://github.com/Xposed-Modules-Repo/com.fanqie.xfqdeobf/releases/)](https://github.com/Xposed-Modules-Repo/com.fanqie.xfqdeobf/releases/) 将只发布 `推荐的CI` 版更新。
