...
package me.hd.hook.simplify.main.ui.misc
...
object RemoveCommentAd : CommonSwitchFunctionHook() {
    ...
    override fun initOnce(): Boolean {
        "com.tencent.biz.qqcircle.adapter.QFSCommentBlock".toHostClass().singleMethod {
            name("onBindViewHolder") &&
                parameters("androidx.recyclerview.widget.RecyclerView\$ViewHolder".toHostClass(), Int::class.java)
