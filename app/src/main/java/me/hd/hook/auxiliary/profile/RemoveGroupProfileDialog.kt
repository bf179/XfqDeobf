            ...
            .singleMethod {
                name("processProfileCard") &&
                    if (requireMinQQVersion(QQVersion.QQ_9_0_0)) {
                        parameters(Bundle::class.java, "SummaryCard.RespHead".toHostClass(), "SummaryCard.RespSummaryCard".toHostClass())
                    } else {
                        parameters("SummaryCard.RespHead".toHostClass(), "SummaryCard.RespSummaryCard".toHostClass())
                    }
