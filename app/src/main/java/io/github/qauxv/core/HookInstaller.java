...
import com.fanqie.xfqdeobf.util.dexkit.DexDeobfsBackend;
    ...
    public static IDynamicHook[] queryAllAnnotatedHooks() {
        ...
        synchronized (HookInstaller.class) {
            if (sAnnotatedHooks == null) {
                ...
                try {
                    sAnnotatedHooks = com.fanqie.xfqdeobf.gen.AnnotatedFunctionHookEntryList.getAnnotatedFunctionHookEntryList();
