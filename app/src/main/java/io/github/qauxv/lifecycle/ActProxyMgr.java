...
public class ActProxyMgr {
    ...
    @MagicConstant
    public static final String ACTIVITY_PROXY_INTENT = "com.fanqie.xfqdeobf.lifecycle.ActProxyMgr.ACTIVITY_PROXY_INTENT";
    ...
    public static boolean isModuleProxyActivity(@NonNull String className) {
        return className.startsWith("com.fanqie.xfqdeobf.activity.")
            ...
            || "com.fanqie.xfqdeobf.util.consis.ShadowStartupAgentActivity".equals(className);
    }
