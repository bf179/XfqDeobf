 ...
 */
package com.fanqie.xfqdeobf.poststartup;
...
import com.fanqie.xfqdeobf.core.MainHook;
...
import com.fanqie.xfqdeobf.util.hookimpl.InMemoryClassLoaderHelper;
import com.fanqie.xfqdeobf.util.hookimpl.LibXposedNewApiByteCodeGenerator;
import com.fanqie.xfqdeobf.util.hookimpl.lsplant.LsplantHookImpl;
        ...
        if (HostInfo.isInHostProcess() && HostInfo.getHostInfo().getVersionCode32() == 1) {
            if ("com.tencent.mobileqq".equals(ctx.getPackageName())) {
                ...
                try {
                    ...
                    com.fanqie.xfqdeobf.util.Log.e("Failed to get version code from Lcooperation/qzone/QUA;->QUA:Ljava/lang/String;", e);
                }
            }
        }
    }
