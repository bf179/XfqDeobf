...
package com.fanqie.xfqdeobf.util.hookimpl.lsplant;
...
public class LsplantHookImpl {
    ...
    private static void checkHookTarget(@NonNull Member target) {
        ...
        if (clazz.getName().startsWith("com.fanqie.xfqdeobf.")) {
            throw new IllegalArgumentException("Cannot hook com.fanqie.xfqdeobf.* classes");
        }
    }
