 ...
 */
package com.fanqie.xfqdeobf.util;
...
public class SyncUtils {
    ...
    //file=0
    public static final String SYNC_FILE_CHANGED = "com.fanqie.xfqdeobf.SYNC_FILE_CHANGED";
    //process=010001 hook=0011000
    public static final String HOOK_DO_INIT = "com.fanqie.xfqdeobf.HOOK_DO_INIT";
    public static final String ENUM_PROC_REQ = "com.fanqie.xfqdeobf.ENUM_PROC_REQ";
    public static final String ENUM_PROC_RESP = "com.fanqie.xfqdeobf.ENUM_PROC_RESP";
    public static final String GENERIC_WRAPPER = "com.fanqie.xfqdeobf.GENERIC_WRAPPER";
