...
import com.fanqie.xfqdeobf.config.ConfigManager.getExFriendCfg
import com.fanqie.xfqdeobf.dsl.FunctionEntryRouter
import com.fanqie.xfqdeobf.hook.CommonConfigFunctionHook
import com.fanqie.xfqdeobf.tlb.ConfigTable.getConfig
...
import com.fanqie.xfqdeobf.util.dexkit.NChatActivityFacade_sendMsgButton
import com.fanqie.xfqdeobf.util.dexkit.NQQSettingMe_onResume
...
object ChatWordsCount : CommonConfigFunctionHook("na_chat_words_count_kt", arrayOf(NQQSettingMe_onResume, NChatActivityFacade_sendMsgButton)) {
    ...
    private fun updateChatWordView(viewGroup: ViewGroup) {
        ...
        var textView: TextView? = ghostFrameLayout.findViewById(com.fanqie.xfqdeobf.R.id.chat_words_count)
        if (textView == null) {
            injectChatWordView(viewGroup.context, ghostFrameLayout)
            textView = (relativeLayout.parent as ViewGroup).findViewById(com.fanqie.xfqdeobf.R.id.chat_words_count)
        }
    ...
    private fun injectChatWordView(context: Context, viewGroup: ViewGroup) {
        ...
        textView.id = com.fanqie.xfqdeobf.R.id.chat_words_count
