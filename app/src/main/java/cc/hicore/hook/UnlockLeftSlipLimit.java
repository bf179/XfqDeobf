...
public class UnlockLeftSlipLimit extends CommonSwitchFunctionHook {
    ...
    protected boolean initOnce() throws Exception {
        ...
        Method m = XMethod.clz(DexKit.requireMethodFromCache(NLeftSwipeReplyHelper_reply.INSTANCE).getDeclaringClass())
                .name(com.fanqie.xfqdeobf.util.HostInfo.requireRangePlayQQVersion(PlayQQVersion.PlayQQ_8_2_11, PlayQQVersion.PlayQQ_8_2_11) ? "c" : !HostInfo.requireMinQQVersion(QQVersion.QQ_8_8_93) ? "h" : HostInfo.requireMinQQVersion(QQVersion.QQ_8_9_33) ? "I" : "H")
                .ret(boolean.class)
                .get();
