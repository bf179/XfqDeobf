...
import com.fanqie.xfqdeobf.fragment.BaseRootLayoutFragment
import com.fanqie.xfqdeobf.util.SyncUtils
import com.fanqie.xfqdeobf.util.dexkit.DexMethodDescriptor
import com.fanqie.xfqdeobf.util.soloader.NativeLoader
...
private fun makeJniHeader(klass: Class<*>): String {
    // void Java_com_fanqie_xfqdeobf_util_Natives_free(JNIEnv* env, jclass klass, jlong j1);
