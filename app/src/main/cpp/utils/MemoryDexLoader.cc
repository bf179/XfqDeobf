...
Java_com_fanqie_xfqdeobf_util_dyn_MemoryDexLoader_nativeCreateClassLoaderWithDexBelowOreo(JNIEnv* env, jclass clazz, jbyteArray dex_file, jobject parent) {
...
extern "C" JNIEXPORT jobject JNICALL
Java_com_fanqie_xfqdeobf_util_dyn_MemoryDexLoader_nativeCreateDexFileFormBytesBelowOreo(JNIEnv* env,
                                                                                    jclass clazz,
...
static JNINativeMethod gMethods[] = {
        {"nativeCreateClassLoaderWithDexBelowOreo", "([BLjava/lang/ClassLoader;)Ljava/lang/ClassLoader;", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_dyn_MemoryDexLoader_nativeCreateClassLoaderWithDexBelowOreo)},
