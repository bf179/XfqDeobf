...
Java_com_fanqie_xfqdeobf_util_hookimpl_lsplant_LsplantBridge_nativeInitializeLsplant(JNIEnv* env, jclass clazz) {
...
Java_com_fanqie_xfqdeobf_util_hookimpl_lsplant_LsplantBridge_nativeHookMethod(JNIEnv* env, jclass clazz, jobject target, jobject callback, jobject context) {
    if (!sLsplantInitSuccess) {
...
Java_com_fanqie_xfqdeobf_util_hookimpl_lsplant_LsplantBridge_nativeIsMethodHooked(JNIEnv* env, jclass clazz, jobject target) {
    if (!sLsplantInitSuccess) {
        env->ThrowNew(env->FindClass("java/lang/IllegalAccessException"), "lsplant not initialized");
        return false;
    }
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_fanqie_xfqdeobf_util_hookimpl_lsplant_LsplantBridge_nativeUnhookMethod(JNIEnv* env, jclass clazz, jobject target) {
    if (!sLsplantInitSuccess) {
        env->ThrowNew(env->FindClass("java/lang/IllegalAccessException"), "lsplant not initialized");
        return false;
    }
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_fanqie_xfqdeobf_util_hookimpl_lsplant_LsplantBridge_nativeDeoptimizeMethod(JNIEnv* env, jclass clazz, jobject target) {
    if (!sLsplantInitSuccess) {
        env->ThrowNew(env->FindClass("java/lang/IllegalAccessException"), "lsplant not initialized");
        return false;
    }
...
static JNINativeMethod gMethods[] = {
    {"nativeInitializeLsplant", "()V", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_hookimpl_lsplant_LsplantBridge_nativeInitializeLsplant)},
    {"nativeHookMethod", "(Ljava/lang/reflect/Member;Ljava/lang/reflect/Member;Ljava/lang/Object;)Ljava/lang/reflect/Method;", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_hookimpl_lsplant_LsplantBridge_nativeHookMethod)},
    {"nativeIsMethodHooked", "(Ljava/lang/reflect/Member;)Z", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_hookimpl_lsplant_LsplantBridge_nativeIsMethodHooked)},
    {"nativeUnhookMethod", "(Ljava/lang/reflect/Member;)Z", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_hookimpl_lsplant_LsplantBridge_nativeUnhookMethod)},
    {"nativeDeoptimizeMethod", "(Ljava/lang/reflect/Member;)Z", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_hookimpl_lsplant_LsplantBridge_nativeDeoptimizeMethod)},
};
// @formatter:on

REGISTER_PRIMARY_PRE_INIT_NATIVE_METHODS("com/fanqie/xfqdeobf/util/hookimpl/lsplant/LsplantBridge", gMethods);
