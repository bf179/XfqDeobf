...
Java_com_fanqie_xfqdeobf_util_ptt_SilkEncodeUtils_nativePcm16leToSilkII(JNIEnv *env,
                                                                    jclass,
                                                                    jint input_fd,
                                                                    jint output_fd,
                                                                    jint sample_rate,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_fanqie_xfqdeobf_util_ptt_SilkEncodeUtils_nativePcm16leToSilkIS(JNIEnv *env,
                                                                    jclass,
                                                                    jint input_fd,
                                                                    jstring output_path,
                                                                    jint sample_rate,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_fanqie_xfqdeobf_util_ptt_SilkEncodeUtils_nativePcm16leToSilkSS(JNIEnv *env,
                                                                    jclass,
                                                                    jstring input_path,
                                                                    jstring output_path,
                                                                    jint sample_rate,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_fanqie_xfqdeobf_util_ptt_SilkEncodeUtils_nativePcm16leToSilkSI(JNIEnv *env,
                                                                    jclass clazz,
                                                                    jstring input_path,
                                                                    jint output_fd,
                                                                    jint sample_rate,
...
static JNINativeMethod gMethods[] = {
        {"nativePcm16leToSilkII", "(IIIIIZ)V", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_ptt_SilkEncodeUtils_nativePcm16leToSilkII)},
        {"nativePcm16leToSilkIS", "(ILjava/lang/String;IIIZ)V", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_ptt_SilkEncodeUtils_nativePcm16leToSilkIS)},
        {"nativePcm16leToSilkSI", "(Ljava/lang/String;IIIIZ)V", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_ptt_SilkEncodeUtils_nativePcm16leToSilkSI)},
