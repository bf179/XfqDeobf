...
/*
 * Class:     com_fanqie_xfqdeobf_util_Natives
 * Method:    mwrite
 * Signature: (JI[BI)V
 */
EXPORT extern "C" void Java_com_fanqie_xfqdeobf_util_Natives_mwrite
 ...
 * Signature: (JI[BI)V
 */
EXPORT extern "C" void Java_com_fanqie_xfqdeobf_util_Natives_mread
 ...
 * Signature: (I)J
 */
EXPORT extern "C" jlong Java_com_fanqie_xfqdeobf_util_Natives_malloc
 ...
 * Signature: (J)V
 */
EXPORT extern "C" void Java_com_fanqie_xfqdeobf_util_Natives_free(JNIEnv*, jclass, jlong ptr) {
    if (ptr != 0L) {
        free((void*) ptr);
    }
}
...
Java_com_fanqie_xfqdeobf_util_Natives_memcpy(JNIEnv*, jclass, jlong dest, jlong src, jint n) {
 ...
 * Signature: (JII)V
 */
EXPORT extern "C" void Java_com_fanqie_xfqdeobf_util_Natives_memset
...
Java_com_fanqie_xfqdeobf_util_Natives_mprotect(JNIEnv*, jclass, jlong addr, jint len, jint prot) {
...
Java_com_fanqie_xfqdeobf_util_Natives_dlsym(JNIEnv* env, jclass, jlong h, jstring name) {
    const char* p;
    jboolean copy;
 ...
 */
EXPORT extern "C" jlong
Java_com_fanqie_xfqdeobf_util_Natives_dlopen(JNIEnv* env, jclass, jstring name, jint flag) {
    const char* p;
    jboolean copy;
    p = env->GetStringUTFChars(name, &copy);
    if (!p)return 0;
 ...
 * Signature: (J)I
 */
EXPORT extern "C" jint Java_com_fanqie_xfqdeobf_util_Natives_dlclose(JNIEnv*, jclass, jlong h) {
 ...
 */
EXPORT extern "C" jstring Java_com_fanqie_xfqdeobf_util_Natives_dlerror
        (JNIEnv* env, jclass) {
 ...
 * Signature: ()I
 */
EXPORT extern "C" jint Java_com_fanqie_xfqdeobf_util_Natives_sizeofptr(JNIEnv*, jclass) {
    return sizeof(void*);
}
 ...
 * Signature: ()I
 */
EXPORT extern "C" jint Java_com_fanqie_xfqdeobf_util_Natives_getpagesize(JNIEnv*, jclass) {
    return getpagesize();
}
 ...
 * Signature: (J)J
 */
EXPORT extern "C" jlong Java_com_fanqie_xfqdeobf_util_Natives_call__J(JNIEnv* env, jclass, jlong addr) {
    void* (* fun)();
    fun = (void* (*)()) (addr);
    if (fun == nullptr) {
 ...
 * Signature: (JJ)J
 */
EXPORT extern "C" jlong Java_com_fanqie_xfqdeobf_util_Natives_call__JJ
...
Java_com_fanqie_xfqdeobf_util_Natives_allocateInstanceImpl(JNIEnv* env, jclass, jclass targetClass) {
...
extern "C" JNIEXPORT jobject JNICALL
Java_com_fanqie_xfqdeobf_util_Natives_invokeNonVirtualImpl(JNIEnv* env, jclass,
...
Java_com_fanqie_xfqdeobf_util_Natives_write(JNIEnv* env, jclass clazz, jint fd, jbyteArray buf, jint offset, jint len) {
...
extern "C" JNIEXPORT jint JNICALL
Java_com_fanqie_xfqdeobf_util_Natives_read(JNIEnv* env, jclass, jint fd, jbyteArray buf, jint offset, jint len) {
    requiresNonNullZ(buf, "buf is null");
    if (fd < 0) {
        env->ThrowNew(env->FindClass("java/lang/IllegalArgumentException"),
                      (std::string("fd is negative: ") + std::to_string(fd)).c_str());
...
Java_com_fanqie_xfqdeobf_util_Natives_close(JNIEnv* env, jclass, jint fd) {
    if (fd < 0) {
        env->ThrowNew(env->FindClass("java/lang/IllegalArgumentException"),
                      (std::string("fd is negative: ") + std::to_string(fd)).c_str());
        return;
...
extern "C" JNIEXPORT jint JNICALL
Java_com_fanqie_xfqdeobf_util_MemoryFileUtils_nativeInitializeTmpDir(JNIEnv* env, jclass, jstring jcacheDir) {
...
extern "C" JNIEXPORT jint JNICALL
Java_com_fanqie_xfqdeobf_util_MemoryFileUtils_nativeCreateMemoryFile0(JNIEnv* env, jclass, jstring name, jint size) {
    if (strlen(sTmpDir) == 0) {
...
extern "C" JNIEXPORT jint JNICALL
Java_com_fanqie_xfqdeobf_util_Natives_getProcessDumpableState(JNIEnv* env, jclass) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_fanqie_xfqdeobf_util_Natives_setProcessDumpableState(JNIEnv* env, jclass, jint dumpable) {
...
Java_com_fanqie_xfqdeobf_util_Natives_lseek(JNIEnv* env, jclass, jint fd, jlong offset, jint whence) {
    if (fd < 0) {
        env->ThrowNew(env->FindClass("java/lang/IllegalArgumentException"),
                      (std::string("fd is negative: ") + std::to_string(fd)).c_str());
        return -1;
...
Java_com_fanqie_xfqdeobf_util_Natives_dup(JNIEnv* env, jclass clazz, jint fd) {
    if (fd < 0) {
        env->ThrowNew(env->FindClass("java/lang/IllegalArgumentException"),
                      (std::string("fd is negative: ") + std::to_string(fd)).c_str());
        return -1;
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_fanqie_xfqdeobf_util_Natives_dup2(JNIEnv* env,
                                       jclass clazz,
                                       jint oldfd,
                                       jint newfd) {
    if (oldfd < 0) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_fanqie_xfqdeobf_util_Natives_dup3(JNIEnv* env,
                                       jclass clazz,
                                       jint oldfd,
                                       jint newfd,
                                       jint flags) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_fanqie_xfqdeobf_util_Natives_open(JNIEnv* env,
                                       jclass clazz,
                                       jstring path,
                                       jint flags,
                                       jint mode) {
...
Java_com_fanqie_xfqdeobf_util_Natives_invokeNonVirtualArtMethodImpl(JNIEnv* env,
                                                                jclass clazz,
                                                                jobject member,
                                                                jstring signature,
                                                                jclass klass,
...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_fanqie_xfqdeobf_util_Natives_getReflectedMethod(JNIEnv* env, jclass clazz, jclass cls, jstring name, jstring sig, jboolean is_static) {
...
static JNINativeMethod gMethods[] = {
    {"allocateInstanceImpl", "(Ljava/lang/Class;)Ljava/lang/Object;", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_allocateInstanceImpl)},
    {"call", "(J)J", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_call__J)},
    {"call", "(JJ)J", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_call__JJ)},
    {"close", "(I)V", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_close)},
    {"dlclose", "(J)I", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_dlclose)},
    {"dlerror", "()Ljava/lang/String;", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_dlerror)},
    {"dlopen", "(Ljava/lang/String;I)J", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_dlopen)},
    {"dlsym", "(JLjava/lang/String;)J", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_dlsym)},
    {"dup", "(I)I", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_dup)},
    {"dup2", "(II)I", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_dup2)},
    {"dup3", "(III)I", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_dup3)},
    {"free", "(J)V", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_free)},
    {"getProcessDumpableState", "()I", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_getProcessDumpableState)},
    {"getpagesize", "()I", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_getpagesize)},
    {"invokeNonVirtualArtMethodImpl", "(Ljava/lang/reflect/Member;Ljava/lang/String;Ljava/lang/Class;ZLjava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_invokeNonVirtualArtMethodImpl)},
    {"invokeNonVirtualImpl", "(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_invokeNonVirtualImpl)},
    {"lseek", "(IJI)J", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_lseek)},
    {"malloc", "(I)J", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_malloc)},
    {"memcpy", "(JJI)V", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_memcpy)},
    {"memset", "(JII)V", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_memset)},
    {"mprotect", "(JII)I", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_mprotect)},
    {"mread", "(JI[BI)V", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_mread)},
    {"mwrite", "(JI[BI)V", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_mwrite)},
    {"open", "(Ljava/lang/String;II)I", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_open)},
    {"read", "(I[BII)I", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_read)},
    {"setProcessDumpableState", "(I)V", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_setProcessDumpableState)},
    {"sizeofptr", "()I", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_sizeofptr)},
    {"write", "(I[BII)I", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_write)},
    {"getReflectedMethod", "(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/reflect/Member;", reinterpret_cast<void*>(Java_com_fanqie_xfqdeobf_util_Natives_getReflectedMethod)},
};
//@formatter:on
