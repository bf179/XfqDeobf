...
val buildAllAbiForDebug = Version.getLocalProperty(project, "xfqdeobf.override.forceallabi")
    ?.toBoolean() ?: false
val isNewXposedApiEnabled = Version.getLocalProperty(project, "xfqdeobf.override.newxposedapi")
    ?.toBoolean() ?: true
val isNativeFullDebugMode = Version.getLocalProperty(project, "xfqdeobf.override.nativefulldebug")
    ?.toBoolean() ?: false
...
android {
    namespace = "com.fanqie.xfqdeobf"
    ndkVersion = Version.getNdkVersion(rootProject)
    defaultConfig {
        applicationId = "com.fanqie.xfqdeobf"
    ...
    doLast {
        ...
        ZFile.openReadOnly(inputApk).use { srcApk ->
            ...
            requiredAbiList.forEach { abi ->
                val path = "lib/$abi/libxfqdeobf-core0.so"
