package com.fanqie.xfqdeobf.startup;
...
public class UnifiedEntryPoint {
    ...
    private static void callNextStep(
        ...
        try {
            Class<?> kStartupAgent = Class.forName("com.fanqie.xfqdeobf.poststartup.StartupAgent", false, UnifiedEntryPoint.class.getClassLoader());
