...
class UiItemAgentEntryProcessor(
    ...
    override fun process(resolver: Resolver): List<KSAnnotated> {
        val symbols = resolver.getSymbolsWithAnnotation("com.fanqie.xfqdeobf.base.annotation.UiItemAgentEntry")
        ...
        val uiProvider = ClassName("com.fanqie.xfqdeobf.base", "IUiItemAgentProvider")
        ...
        FileSpec.builder("com.fanqie.xfqdeobf.gen", "AnnotatedUiItemAgentEntryList")
