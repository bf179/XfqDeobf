...
class FunctionHookEntryItemProcessor(
    ...
    override fun process(resolver: Resolver): List<KSAnnotated> {
        val symbols = resolver.getSymbolsWithAnnotation("com.fanqie.xfqdeobf.base.annotation.FunctionHookEntry")
        ...
        val hook = ClassName("com.fanqie.xfqdeobf.base", "IDynamicHook")
        ...
        FileSpec.builder("com.fanqie.xfqdeobf.gen", "AnnotatedFunctionHookEntryList")
